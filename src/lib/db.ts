...
const initialStudents: Student[] = [
    ...
    // Bharatanatyam
    { id: "S051", name: "Aarav Sharma", email: "aarav.s@example.com", joined: new Date("2024-07-02").toISOString(), status: "Active", courses: 1, avatar: "https://placehold.co/100x100.png", initials: "AS", desiredCourse: 'bharatanatyam', enrolledCourses: ['bharatanatyam'], whatsappNumber: '9876543260', admissionCenter: 'Main Campus (Basavanapura)' },
    { id: "S052", name: "Diya Patel", email: "diya.p@example.com", joined: new Date("2024-07-03").toISOString(), status: "Active", courses: 1, avatar: "https://placehold.co/100x100.png", initials: "DP", desiredCourse: 'bharatanatyam', enrolledCourses: ['bharatanatyam'], whatsappNumber: '9876543261', admissionCenter: 'Branch 2 (Marathahalli)' },
    { id: "S053", name: "Ishaan Iyer", email: "ishaan.i@example.com", joined: new Date("2024-07-04").toISOString(), status: "Active", courses: 1, avatar: "https://placehold.co/100x100.png", initials: "II", desiredCourse: 'bharatanatyam', enrolledCourses: ['bharatanatyam'], whatsappNumber: '9876543262', admissionCenter: 'Main Campus (Basavanapura)' },
    // Vocal Carnatic
    { id: "S054", name: "Myra Reddy", email: "myra.r@example.com", joined: new Date("2024-07-05").toISOString(), status: "Active", courses: 1, avatar: "https://placehold.co/100x100.png", initials: "MR", desiredCourse: 'vocal-carnatic', enrolledCourses: ['vocal-carnatic'], whatsappNumber: '9876543263', admissionCenter: 'Branch 3 (Koramangala)' },
    { id: "S055", name: "Vihaan Kumar", email: "vihaan.k@example.com", joined: new Date("2024-07-06").toISOString(), status: "Active", courses: 1, avatar: "https://placehold.co/100x100.png", initials: "VK", desiredCourse: 'vocal-carnatic', enrolledCourses: ['vocal-carnatic'], whatsappNumber: '9876543264', admissionCenter: 'Branch 2 (Marathahalli)' },
    { id: "S056", name: "Anika Singh", email: "anika.s@example.com", joined: new Date("2024-07-07").toISOString(), status: "Active", courses: 1, avatar: "https://placehold.co/100x100.png", initials: "AS", desiredCourse: 'vocal-carnatic', enrolledCourses: ['vocal-carnatic'], whatsappNumber: '9876543265', admissionCenter: 'Main Campus (Basavanapura)' },
    // Guitar
    { id: "S057", name: "Kabir Gupta", email: "kabir.g@example.com", joined: new Date("2024-07-08").toISOString(), status: "Active", courses: 1, avatar: "https://placehold.co/100x100.png", initials: "KG", desiredCourse: 'guitar', enrolledCourses: ['guitar'], whatsappNumber: '9876543266', admissionCenter: 'Branch 4 (Indiranagar)' },
    { id: "S058", name: "Saanvi Shah", email: "saanvi.s@example.com", joined: new Date("2024-07-09").toISOString(), status: "Active", courses: 1, avatar: "https://placehold.co/100x100.png", initials: "SS", desiredCourse: 'guitar', enrolledCourses: ['guitar'], whatsappNumber: '9876543267', admissionCenter: 'Branch 5 (Jayanagar)' },
    { id: "S059", name: "Advik Das", email: "advik.d@example.com", joined: new Date("2024-07-10").toISOString(), status: "Active", courses: 1, avatar: "https://placehold.co/100x100.png", initials: "AD", desiredCourse: 'guitar', enrolledCourses: ['guitar'], whatsappNumber: '9876543268', admissionCenter: 'Branch 2 (Marathahalli)' },
    // Keyboard/Piano
    { id: "S060", name: "Zara Ali", email: "zara.a@example.com", joined: new Date("2024-07-11").toISOString(), status: "Active", courses: 1, avatar: "https://placehold.co/100x100.png", initials: "ZA", desiredCourse: 'keyboard-piano', enrolledCourses: ['keyboard-piano'], whatsappNumber: '9876543269', admissionCenter: 'Main Campus (Basavanapura)' },
    { id: "S061", name: "Ayaan Khan", email: "ayaan.k@example.com", joined: new Date("2024-07-12").toISOString(), status: "Active", courses: 1, avatar: "https://placehold.co/100x100.png", initials: "AK", desiredCourse: 'keyboard-piano', enrolledCourses: ['keyboard-piano'], whatsappNumber: '9876543270', admissionCenter: 'Branch 3 (Koramangala)' },
    { id: "S062", name: "Kiara Menon", email: "kiara.m@example.com", joined: new Date("2024-07-13").toISOString(), status: "Active", courses: 1, avatar: "https://placehold.co/100x100.png", initials: "KM", desiredCourse: 'keyboard-piano', enrolledCourses: ['keyboard-piano'], whatsappNumber: '9876543271', admissionCenter: 'Branch 4 (Indiranagar)' },
    // Yoga
    { id: "S063", name: "Rohan Joshi", email: "rohan.j@example.com", joined: new Date("2024-07-14").toISOString(), status: "Active", courses: 1, avatar: "https://placehold.co/100x100.png", initials: "RJ", desiredCourse: 'yoga', enrolledCourses: ['yoga'], whatsappNumber: '9876543272', admissionCenter: 'Branch 5 (Jayanagar)' },
    { id: "S064", name: "Pari Verma", email: "pari.v@example.com", joined: new Date("2024-07-15").toISOString(), status: "Active", courses: 1, avatar: "https://placehold.co/100x100.png", initials: "PV", desiredCourse: 'yoga', enrolledCourses: ['yoga'], whatsappNumber: '9876543273', admissionCenter: 'Main Campus (Basavanapura)' },
    { id: "S065", name: "Arjun Nair", email: "arjun.n@example.com", joined: new Date("2024-07-16").toISOString(), status: "Active", courses: 1, avatar: "https://placehold.co/100x100.png", initials: "AN", desiredCourse: 'yoga', enrolledCourses: ['yoga'], whatsappNumber: '9876543274', admissionCenter: 'Branch 2 (Marathahalli)' },
    // Western Dance
    { id: "S066", name: "Eva DSouza", email: "eva.d@example.com", joined: new Date("2024-07-17").toISOString(), status: "Active", courses: 1, avatar: "https://placehold.co/100x100.png", initials: "ED", desiredCourse: 'western-dance', enrolledCourses: ['western-dance'], whatsappNumber: '9876543275', admissionCenter: 'Branch 3 (Koramangala)' },
    { id: "S067", name: "Vivaan Roy", email: "vivaan.r@example.com", joined: new Date("2024-07-18").toISOString(), status: "Active", courses: 1, avatar: "https://placehold.co/100x100.png", initials: "VR", desiredCourse: 'western-dance', enrolledCourses: ['western-dance'], whatsappNumber: '9876543276', admissionCenter: 'Branch 4 (Indiranagar)' },
    { id: "S068", name: "Shanaya Kapoor", email: "shanaya.k@example.com", joined: new Date("2024-07-19").toISOString(), status: "Active", courses: 1, avatar: "https://placehold.co/100x100.png", initials: "SK", desiredCourse: 'western-dance', enrolledCourses: ['western-dance'], whatsappNumber: '9876543277', admissionCenter: 'Branch 5 (Jayanagar)' },
    // Art & Craft
    { id: "S069", name: "Aisha Begum", email: "aisha.b@example.com", joined: new Date("2024-07-20").toISOString(), status: "Active", courses: 1, avatar: "https://placehold.co/100x100.png", initials: "AB", desiredCourse: 'art-craft', enrolledCourses: ['art-craft'], whatsappNumber: '9876543278', admissionCenter: 'Main Campus (Basavanapura)' },
    { id: "S070", name: "Neil Bhatt", email: "neil.b@example.com", joined: new Date("2024-07-21").toISOString(), status: "Active", courses: 1, avatar: "https://placehold.co/100x100.png", initials: "NB", desiredCourse: 'art-craft', enrolledCourses: ['art-craft'], whatsappNumber: '9876543279', admissionCenter: 'Branch 2 (Marathahalli)' },
    { id: "S071", name: "Rhea Chawla", email: "rhea.c@example.com", joined: new Date("2024-07-22").toISOString(), status: "Active", courses: 1, avatar: "https://placehold.co/100x100.png", initials: "RC", desiredCourse: 'art-craft', enrolledCourses: ['art-craft'], whatsappNumber: '9876543280', admissionCenter: 'Branch 3 (Koramangala)' },
    // Karate
    { id: "S072", name: "Samir Jain", email: "samir.j@example.com", joined: new Date("2024-07-23").toISOString(), status: "Active", courses: 1, avatar: "https://placehold.co/100x100.png", initials: "SJ", desiredCourse: 'karate', enrolledCourses: ['karate'], whatsappNumber: '9876543281', admissionCenter: 'Branch 4 (Indiranagar)' },
    { id: "S073", name: "Tara Khanna", email: "tara.k@example.com", joined: new Date("2024-07-24").toISOString(), status: "Active", courses: 1, avatar: "https://placehold.co/100x100.png", initials: "TK", desiredCourse: 'karate', enrolledCourses: ['karate'], whatsappNumber: '9876543282', admissionCenter: 'Branch 5 (Jayanagar)' },
    { id: "S074", name: "Yash Mathur", email: "yash.m@example.com", joined: new Date("2024-07-25").toISOString(), status: "Active", courses: 1, avatar: "https://placehold.co/100x100.png", initials: "YM", desiredCourse: 'karate', enrolledCourses: ['karate'], whatsappNumber: '9876543283', admissionCenter: 'Main Campus (Basavanapura)' },
    // Kalaripayattu
    { id: "S075", name: "Aditi Pillai", email: "aditi.p@example.com", joined: new Date("2024-07-26").toISOString(), status: "Active", courses: 1, avatar: "https://placehold.co/100x100.png", initials: "AP", desiredCourse: 'kalaripayattu', enrolledCourses: ['kalaripayattu'], whatsappNumber: '9876543284', admissionCenter: 'Branch 2 (Marathahalli)' },
    { id: "S076", name: "Dhruv Menon", email: "dhruv.m@example.com", joined: new Date("2024-07-27").toISOString(), status: "Active", courses: 1, avatar: "https://placehold.co/100x100.png", initials: "DM", desiredCourse: 'kalaripayattu', enrolledCourses: ['kalaripayattu'], whatsappNumber: '9876543285', admissionCenter: 'Branch 3 (Koramangala)' },
    { id: "S077", name: "Inaya Nair", email: "inaya.n@example.com", joined: new Date("2024-07-28").toISOString(), status: "Active", courses: 1, avatar: "https://placehold.co/100x100.png", initials: "IN", desiredCourse: 'kalaripayattu', enrolledCourses: ['kalaripayattu'], whatsappNumber: '9876543286', admissionCenter: 'Main Campus (Basavanapura)' },
    // Zumba
    { id: "S078", name: "Jia Rao", email: "jia.r@example.com", joined: new Date("2024-07-29").toISOString(), status: "Active", courses: 1, avatar: "https://placehold.co/100x100.png", initials: "JR", desiredCourse: 'zumba', enrolledCourses: ['zumba'], whatsappNumber: '9876543287', admissionCenter: 'Branch 4 (Indiranagar)' },
    { id: "S079", name: "Kiaan Seth", email: "kiaan.s@example.com", joined: new Date("2024-07-30").toISOString(), status: "Active", courses: 1, avatar: "https://placehold.co/100x100.png", initials: "KS", desiredCourse: 'zumba', enrolledCourses: ['zumba'], whatsappNumber: '9876543288', admissionCenter: 'Branch 5 (Jayanagar)' },
    { id: "S080", name: "Leah Thomas", email: "leah.t@example.com", joined: new Date("2024-07-31").toISOString(), status: "Active", courses: 1, avatar: "https://placehold.co/100x100.png", initials: "LT", desiredCourse: 'zumba', enrolledCourses: ['zumba'], whatsappNumber: '9876543289', admissionCenter: 'Branch 2 (Marathahalli)' },
    // Gymnastics
    { id: "S081", name: "Mila George", email: "mila.g@example.com", joined: new Date("2024-08-01").toISOString(), status: "Active", courses: 1, avatar: "https://placehold.co/100x100.png", initials: "MG", desiredCourse: 'gymnastics', enrolledCourses: ['gymnastics'], whatsappNumber: '9876543290', admissionCenter: 'Main Campus (Basavanapura)' },
    { id: "S082", name: "Neev Agarwal", email: "neev.a@example.com", joined: new Date("2024-08-02").toISOString(), status: "Active", courses: 1, avatar: "https://placehold.co/100x100.png", initials: "NA", desiredCourse: 'gymnastics', enrolledCourses: ['gymnastics'], whatsappNumber: '9876543291', admissionCenter: 'Branch 3 (Koramangala)' },
    { id: "S083", name: "Aarohi Kulkarni", email: "aarohi.k@example.com", joined: new Date("2024-08-03").toISOString(), status: "Active", courses: 1, avatar: "https://placehold.co/100x100.png", initials: "AK", desiredCourse: 'gymnastics', enrolledCourses: ['gymnastics'], whatsappNumber: '9876543292', admissionCenter: 'Branch 4 (Indiranagar)' },
    // Drums
    { id: "S084", name: "Reyansh Mehta", email: "reyansh.m@example.com", joined: new Date("2024-08-04").toISOString(), status: "Active", courses: 1, avatar: "https://placehold.co/100x100.png", initials: "RM", desiredCourse: 'drums', enrolledCourses: ['drums'], whatsappNumber: '9876543293', admissionCenter: 'Main Campus (Basavanapura)' },
    { id: "S085", name: "Tara Prasad", email: "tara.p@example.com", joined: new Date("2024-08-05").toISOString(), status: "Active", courses: 1, avatar: "https://placehold.co/100x100.png", initials: "TP", desiredCourse: 'drums', enrolledCourses: ['drums'], whatsappNumber: '9876543294', admissionCenter: 'Branch 2 (Marathahalli)' },
    { id: "S086", name: "Zayn Ahmed", email: "zayn.a@example.com", joined: new Date("2024-08-06").toISOString(), status: "Active", courses: 1, avatar: "https://placehold.co/100x100.png", initials: "ZA", desiredCourse: 'drums', enrolledCourses: ['drums'], whatsappNumber: '9876543295', admissionCenter: 'Branch 5 (Jayanagar)' },
    // Violin
    { id: "S087", name: "Alia Bhatt", email: "alia.b@example.com", joined: new Date("2024-08-07").toISOString(), status: "Active", courses: 1, avatar: "https://placehold.co/100x100.png", initials: "AB", desiredCourse: 'violin', enrolledCourses: ['violin'], whatsappNumber: '9876543296', admissionCenter: 'Main Campus (Basavanapura)' },
    { id: "S088", name: "Ranbir Kapoor", email: "ranbir.k@example.com", joined: new Date("2024-08-08").toISOString(), status: "Active", courses: 1, avatar: "https://placehold.co/100x100.png", initials: "RK", desiredCourse: 'violin', enrolledCourses: ['violin'], whatsappNumber: '9876543297', admissionCenter: 'Branch 3 (Koramangala)' },
    { id: "S089", name: "Deepika Padukone", email: "deepika.p@example.com", joined: new Date("2024-08-09").toISOString(), status: "Active", courses: 1, avatar: "https://placehold.co/100x100.png", initials: "DP", desiredCourse: 'violin', enrolledCourses: ['violin'], whatsappNumber: '9876543298', admissionCenter: 'Branch 4 (Indiranagar)' },
    // Piano
    { id: "S090", name: "Shah Rukh Khan", email: "srk@example.com", joined: new Date("2024-08-10").toISOString(), status: "Active", courses: 1, avatar: "https://placehold.co/100x100.png", initials: "SRK", desiredCourse: 'piano', enrolledCourses: ['piano'], whatsappNumber: '9876543299', admissionCenter: 'Branch 5 (Jayanagar)' },
    { id: "S091", name: "Priyanka Chopra", email: "pc@example.com", joined: new Date("2024-08-11").toISOString(), status: "Active", courses: 1, avatar: "https://placehold.co/100x100.png", initials: "PC", desiredCourse: 'piano', enrolledCourses: ['piano'], whatsappNumber: '9876543300', admissionCenter: 'Main Campus (Basavanapura)' },
    { id: "S092", name: "Hrithik Roshan", email: "hr@example.com", joined: new Date("2024-08-12").toISOString(), status: "Active", courses: 1, avatar: "https://placehold.co/100x100.png", initials: "HR", desiredCourse: 'piano', enrolledCourses: ['piano'], whatsappNumber: '9876543301', admissionCenter: 'Branch 2 (Marathahalli)' },
];
